...
bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=250;this.height=a-40;this.maxHeight=this.height-75;this.stage.css({height:this.height+"px",top:b+"px"});this.tableofcontentSwiper.css("height",this.maxHeight+"px");this.elements.refresh()},show:function(){this.visible=!0;this.stage.animate({left:10},400,function(){}.bind(this));this.onShow();if(this.nailUpStatus){var a=$(".tableofcontent_form").outerWidth(!0);bookConfig.leftMargin+=a+10;onStageResize();
var b=parseInt(_get(global,"staticAd.adPosition",1));window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(b)&&$("#slide-show").css({width:"calc(100% - 10px - "+a+"px)",right:"0px"})}},hide:function(){this.visible=!1;this.stage.animate({left:2*-this.width},400,function(){this.onHide()}.bind(this));if(this.nailUpStatus){var a=$(".tableofcontent_form").outerWidth(!0);bookConfig.leftMargin-=a+10;onStageResize();a=parseInt(_get(global,"staticAd.adPosition",1));window.staticAd&&
window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2].includes(a)&&$("#slide-show").css({width:"100%",right:"0px"})}}}).extend(PcTableOfContentFrame);var PcVideoGalleryForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.video);this.stage.append(this.info);if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoListTitle);a.append(this.videoSwiper);
