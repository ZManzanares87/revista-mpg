...
unLoading:function(){this.image.removeAttr("style")},setStyle:function(a){this.item.css(a)},initEvent:function(){this.item.onTap(function(){gotoPageFun(this.index,!1,"thumbnail")}.bind(this))},fillContent:function(a){a=function(b){this.unLoading();b.match(/^none/)?(this.noThumbBg.css({display:"block",width:this.imageWidth+"px"}),this.image.attr("src","").css({display:"none"})):(this.image.attr("src",b),this.noThumbBg.css({display:"none"}),this.image.css({display:"inline-block",width:this.imageWidth+
"px","max-width":"100%","max-height":"100%","object-fit":"contain"}))}.bind(this);pageResourceLoad(this.index,"thumb",a)},getDom:function(){return this.item},fission:function(){this.item.removeClass("highlight");this.item.addClass("focus")},merge:function(){this.item.removeClass("focus")},setHighLight:function(a){this.index==a&&this.item.addClass("highlight")},clearHighLight:function(){this.item.removeClass("highlight")}});var ThumbnailItem=Class({create:function(a){this.parent=a},refreshItem:function(a,b){if(this.pages!=a||b!=this.isMerge)this.item||(this.item=$("<div class='item_focus'></div>"),this.parent.append(this.item),this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor,this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor),this.item.empty(),this.pages=a,this.cells=[],this.isMerge=b,this.initStructure(),this.addItem(),this.item.append(this.title),
a=Color(this.mainColor).split(),this.item.css({"background-color":"rgba("+a.r+","+a.g+","+a.b+", 0.7)"}),this.title.find("span").css({"background-color":"rgba("+a.r+","+a.g+","+a.b+", 0.7)",color:this.fontColor}),this.onResize()},initStructure:function(){this.initCells();for(var a=getShownPageNumber(this.cells[0].index),b=1;b<this.cells.length;b++)a=a+"-"+getShownPageNumber(this.cells[b].index);this.title=$("<div class='title'><span>"+a+"</span></div>")},addItem:function(){for(var a=this.cells.length,
b=0;b<a;b++)this.item.append(this.cells[b].getDom())},initCells:function(){this.isMerge?this.merge():this.fission()},fission:function(){var a=new ThumbnailCell(this.item,this.pages[0]);this.cells.push(a)},merge:function(){for(var a=0;a<this.pages.length;a++){var b=new ThumbnailCell(this.item,this.pages[a]);this.cells.push(b)}},setPositionByEvt:function(a){this.item.css({left:parseInt(a.pageX-this.length/2)+"px"})},onResize:function(){for(var a=this.length=0;a<this.cells.length;a++)this.length+=this.cells[a].length;
this.item.css({width:this.length+"px"})},show:function(){this.item&&this.item.show()},hide:function(){this.item&&this.item.hide()},getLength:function(){return this.length}});var ThumbnailForm=Class({create:function(a){this._super(a);this.pages=[];this.isMerge=!1;this.progressBarWidth=0;this.initHtml();this.initCss();this.initEvent();bookConfig.ToolBarVisible?this.show():this.hide()},initHtml:function(){this.stage=$("<div class='thumbnail_win10'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.itemInfo=new ThumbnailItem(bookContainer);this.progress.append(this.progressBar);this.stage.append(this.progress);
this.parent.append(this.stage)},initCss:function(){rightToLeft&&this.stage.addClass("rightToLeft");this.initColorCss()},initColorCss:function(){this.stage.css({color:this.fontColor})},initEvent:function(){this.progress.onTap(function(a){a=a.srcEvent.pageX-this.progress.offset().left;a=Math.ceil(a/this.progressBarWidth);gotoPageFun(this.pages[a-1][0]);this.progressBar.animate({left:(a-1)*this.progressBarWidth})}.bind(this));this.progress.bind("mousemove",function(a){var b=a.pageX-this.progress.offset().left;
this.refreshItem(this.pages[Math.ceil(b/this.progressBarWidth)-1]);this.itemInfo.setPositionByEvt(a);this.showItem()}.bind(this));this.progress.bind("mouseleave",function(){this.hideItem()}.bind(this));this.progressBar.drag({reference:this.progress,direction:"horizontal",callback:function(a){a=a.srcEvent.pageX-this.progress.offset().left;gotoPageFun(this.pages[Math.ceil(a/this.progressBarWidth)-1][0])}.bind(this)})},refreshItem:function(a){this.itemInfo.refreshItem(a,this.isMerge)},showItem:function(){this.itemInfo.show()},
hideItem:function(){this.itemInfo.hide()},fissionAll:function(){this.isMerge=!1},mergeAll:function(){this.isMerge=!0},setHighLight:function(a){for(var b=0;b<this.pages.length;b++)0<=this.pages[b].indexOf(a)&&this.progressBar.animate({left:b*this.progressBarWidth})},clearHighLight:function(){},getHeight:function(){return this.getTopHeight()+this.getBottomHeight()},getTopHeight:function(){return 0},getBottomHeight:function(){return this.visible?62:0},onResize:function(){this.pages=BookInfo.getThumbnailPages();
var a=this.pages.length;this.width=.5*windowWidth;this.progressBarWidth=this.width/a;this.progressBar.css("width",this.progressBarWidth+"px");if(global.frmTableOfContent&&global.frmTableOfContent.visible&&global.frmTableOfContent.nailUpStatus){var b=$(".tableofcontent_form").outerWidth(!0);this.progress.css("left","calc(25% + "+(b/2+5)+"px)")}else this.progress.css("left","25%");b=BookInfo.getCurrentPageIndex();for(var c=0;c<a;c++)if(0<=this.pages[c].indexOf(b)){this.progressBar.css({left:c*this.progressBarWidth});
break}1>=a&&(this.hide(),this.hideItem())},show:function(){this.visible=!0;this.stage.show();this.onShow();this.setA11y()}}).extend(FormFrame);var toolbar_icons={First:"",
prev:"",
next:"",
Last:"",
home:"",
ZoomIn:"",
ZoomOut:"",
search:"",
thumbnails:"",
tableOfContent:"",
bookmark:"",
autoPlay:"",
stopAutoPlay:"",
soundOn:"",
soundOff:"",
annotation:"",videoGallery:"",
photoGallery:"",
sharethis:"",
print:"",
message:"",download:"",
fullscreen:"",
exitFullscreen:"",
...
about:"",
Help:"",
moreBar:"",
backward:"",
forward:"",
...
wechat:"",
magnifier:"",
text:"",phone:"",
previous_normal:"",
previous_normal_down:"",
next_normal_down:"",
next_normal:""};Class("ButtonQueue",{create:function(a){this.container=a.container;this.extended=a.extended;this.edtNumber=a.edtNumber?a.edtNumber:{body:null,width:0,top:0,space:0};this.buttonWidth=a.buttonWidth;this.buttonTop=a.buttonTop;this.buttons=a.buttons.clone();this.buttonCount=this.buttons.length;this.buttons.each(function(b){b.freedom();b.hint=!0});this.pickButtons()},pickButtons:function(){this.btnFirst=this.buttons.find("first").get(0);this.btnPrevious=this.buttons.find("previous").get(0);this.btnNext=
...
"px"}),f+=d):k.css({display:"none"});f+=l}var d=this.edtNumber.width;d=5<d?d:0;var e=this.container.body,f=a,g=this.buttonWidth,h=this.buttonTop,k=this.edtNumber.body,m=this.edtNumber.top,l=this.edtNumber.space;rightToLeft?(bookConfig.enablePageBack&&b(this.btnForward),b(this.btnLast),b(this.btnNext),c(),b(this.btnPrevious),b(this.btnFirst),bookConfig.enablePageBack&&b(this.btnBackward)):(bookConfig.enablePageBack&&b(this.btnBackward),b(this.btnFirst),b(this.btnPrevious),c(),b(this.btnNext),b(this.btnLast),
bookConfig.enablePageBack&&b(this.btnForward));return f}}).extend("ButtonQueue");Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{initBar:function(){this.removeButton("thumbnail");VolumeControlBar.config={color:this.color.toString(),iconColor:Color(bookConfig.iconColor).toString(),direction:VolumeControlBar.BOTTOM};this.topBar=$('<div class="fbTopBar" id = "fbTopBar"></div>');this.buttonBar=$("<div class='buttonBar'></div>");this.logoBar=$("<div id='logoBar' class='logoBar'></div>");this.edtPageNumber=$("<div class='pageNumber' id='tfPageIndex'><label><input aria-labelledby='currentPageIndex' type='text' id='currentPageIndexTextField' size='5' value='' autocomplete='off' /></label></div>");
this.parent.append(this.topBar);this.topBar.append(this.logoBar);this.topBar.append(this.buttonBar);this.buttonBar.append(this.edtPageNumber);this.initPageNumber()},initPageNumber:function(){var a=this.edtPageNumber.find("input"),b=parseInt(bookConfig.totalPageCount),c=16;""==bookConfig.pageNumberCaption&&(1E4<=b&&(c=16),1E4>b&&(c=10),1E3>b&&(c=7),100>b&&(c=4),10>b&&(c=3));a.attr("size",c);b=Color(this.color.add(120));a.css({color:bookConfig.pageNumColor,"border-right":"1px solid "+b.add(40),"border-bottom":"1px solid "+
b.add(40),"border-left":"1px solid "+b.reduce(20),"border-top":"1px solid "+b.reduce(20)});this.edtPageWidth=this.edtPageNumber.width()},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);global.moreBar=this.extendedBar},setButtonTitle:function(a){if("WeChatShareButton"==a.getClassName())global.WeChatShareImg=new WeChatShare({parent:this.parent,color:"#fff",textColor:bookConfig.toolbarColor,margin:10,padding:10,arrowHeight:12,arrowWidth:12});else if("TelephoneNumberButton"==
a.getClassName())global.PcTelephoneNumberFrame=new PcTelephoneNumberBubble({parent:this.parent,color:this.color,textColor:a.fontColor,margin:8,padding:15,arrowHeight:8,arrowWidth:8});else{var b=new TextBubble({parent:this.parent,text:a.caption,color:this.color,textColor:a.fontColor,margin:7});a.setTitle(b)}},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),bookConfig.ToolBarVisible?this.topBar.append(this.topRightButton):
this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},getTopRightButtonWidth:function(){return this.topRightButton&&this.topRightButton.width()+10||0},onResize:function(a,b){if(bookConfig.ToolBarVisible){a=void 0==a?this.parent.width():parseInt(a);void 0==b?this.parent.height():parseInt(b);b=a/4;var c=a-b-a/4,d=this.edtPageWidth+150+20;if(global.frmTableOfContent&&global.frmTableOfContent.visible&&global.frmTableOfContent.nailUpStatus){var e=
$(".tableofcontent_form").outerWidth(!0);b+=e/2+5}c<d&&(c=d,b=(a-c)/2);this.buttonBar.css({left:b+"px",width:c+"px"});this.logoBar.width()+20>b?this.logoBar.css({display:"none"}):this.logoBar.css({display:"block"});this.buttonBarWidth=c;this.resetButtonPosition()}},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,buttonWidth:30,buttonTop:5,container:{body:this.buttonBar,width:this.buttonBarWidth},extended:this.extendedBar.$bar,edtNumber:{body:this.edtPageNumber,width:this.edtPageWidth,
top:8,space:5}})).sort();this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();this.buttons.each(function(a){a.changeColor();a.$button.mouseEnterLight("rgba(255,255,255,0.3)")}.bind(this))}}).extend("Toolbar");Class("PCExtendedBar",{resize:function(a){for(var b=0;b<a.length;b++)a.get(b).setPosition(5,5+30*b);this.width=160;this.height=30*a.length+10;this.$bar.css({width:this.width+"px",height:this.height+"px"})}}).extend("ExtendedBar");var hexcase=0,b64pad="",chrsz=8;function compareov(){var a=Date.parse(new Date);return orgt(a)===vldt(a)}function orgt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}function vldt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}
